...
export const THead: (props: Omit<TableHeadProps, 'ref'>) => JSX.Element | null =
  React.forwardRef<HTMLTableSectionElement, TableHeadProps>((props, ref) => (
    <MuiTableHead ref={ref} {...props} />
  ));

export const TBody: (props: Omit<TableBodyProps, 'ref'>) => JSX.Element | null =
  React.forwardRef<HTMLTableSectionElement, TableBodyProps>((props, ref) => (
    <MuiTableBody ref={ref} {...props} />
  ));

export const Tr: (props: Omit<TableRowProps, 'ref'>) => JSX.Element | null =
...
export const Td: (props: Omit<TdProps, 'ref'>) => JSX.Element | null =
