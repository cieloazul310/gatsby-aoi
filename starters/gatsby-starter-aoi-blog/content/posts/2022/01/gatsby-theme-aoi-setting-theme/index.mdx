...
以下のファイルは実際にこのサイトで使われているテーマです。ここでは最小限に、[パレット](https://mui.com/customization/palette/)のみの設定をしています。また、[responsiveFontSizes](https://mui.com/customization/typography/#responsive-font-sizes) で画面サイズに合わせた可変のフォントサイズを採用しています。
