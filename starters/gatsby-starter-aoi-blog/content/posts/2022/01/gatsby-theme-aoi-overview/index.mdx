...
[MUI] (旧Material-UI) は、Google が開発している[マテリアルデザイン](https://material.io/design)で構成された [React] コンポーネントです。

Gatsby Theme Aoi は2021年9月にリリースされた [MUI v5](https://mui.com/blog/mui-core-v5/) で構成されています。

#### MUI や emotion の設定不要

Gatsby で MUI を使うには、Gatsby プロジェクト内に自作のプラグインを作成して Gatsby サイト全体を包む [ThemeProvider](https://mui.com/customization/theming/) を設定する必要があります。
